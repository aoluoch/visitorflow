      ...
      <div className="relative w-full max-w-md">
        <div className="bg-navy-800 rounded-2xl shadow-2xl border border-navy-700 overflow-hidden">
          <div className="bg-gradient-to-br from-navy-900 to-navy-800 px-8 pt-10 pb-8 text-center border-b border-navy-700">
            ...
            <p className="text-navy-300 text-sm mt-1">We will email you a reset link</p>
          </div>

          <form onSubmit={handleSubmit} className="px-8 py-8 space-y-5">
            <div>
              <label className="block text-navy-200 text-sm font-medium mb-1.5">Email Address</label>
            ...
            >
              {loading ? <div className="w-5 h-5 border-2 border-navy-900 border-t-transparent rounded-full animate-spin" /> : (<><Send size={18} /> Send Reset Link</>)}
            </button>
